// ignore_for_file: prefer_const_constructors, non_constant_identifier_names, unrelated_type_equality_checks, use_build_context_synchronously, file_names
...
class NewPasswordCentre extends StatefulWidget {
  const NewPasswordCentre({super.key});

  @override
  State<NewPasswordCentre> createState() => _NewPasswordCentreState();
}

class _NewPasswordCentreState extends State<NewPasswordCentre> {
