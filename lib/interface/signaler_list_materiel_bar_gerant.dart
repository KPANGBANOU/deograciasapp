...
import 'centre_informatique/stream_signaler_materiel_bar_gerant.dart';
import 'drawer_gerant.dart';

class BarSignalerListMaterieGerant extends StatelessWidget {
  BarSignalerListMaterieGerant({key});
                    ...
                    ? ListTile(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: ((context) =>
                                      StreamSignalerMaterielBarGerant(
