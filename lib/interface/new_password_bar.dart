...
class NewPasswordBar extends StatefulWidget {
  const NewPasswordBar({super.key});

  @override
  State<NewPasswordBar> createState() => _NewPasswordBarState();
}

class _NewPasswordBarState extends State<NewPasswordBar> {
