...
import 'centre_informatique/stream_recharger_materiel_centre_gerant.dart';
import 'drawer_gerant.dart';

class CentreRechargementListMaterielGerant extends StatelessWidget {
  CentreRechargementListMaterielGerant({key});
                    ...
                    ? ListTile(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: ((context) =>
                                      StreamRechargerMaterielCentreGerant(
