...
import 'stream_de_vente_de_grand_modele_admin.dart';

class VentesDesGrandModeleAdmin extends StatelessWidget {
  VentesDesGrandModeleAdmin({key}) : super(key: key);
        ...
        body: SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: ((context, index) {
                donnesBierresGrandModel _donnes = _bierre_petit_modele[index];
                    ...
                    ? ListTile(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: ((context) =>
                                      StreamDeVenteDeGrandModeleAdmin(
                                          quantite_disponible:
