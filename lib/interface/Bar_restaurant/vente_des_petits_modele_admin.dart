...
import 'stream_de_vente_de_petit_modele.dart';

class VentesDesPetitsModeleAdmin extends StatelessWidget {
  VentesDesPetitsModeleAdmin({key}) : super(key: key);
                    ...
                    ? ListTile(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: ((context) =>
                                      StreamDeVenteDePetitModeleAdmin(
                                          quantite_disponible:
