...
import 'facture_de_vente_de_grand_modele.dart';

class VenteDeGrandModeleAdmin extends StatelessWidget {
  VenteDeGrandModeleAdmin({
    key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Vous disposez de " +
                    ...
                    " unités de cette bièrre en stock",
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Quantit restante de cette bièrre svp",
                      ...
                      if (_quantite.text.isEmpty || quantite <= 0) {
                        ...
                        if (quantite <= _bierre.quantite_physique) {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: ((context) =>
                                      FactureDeVenteDeGrandModeleAdmin(
