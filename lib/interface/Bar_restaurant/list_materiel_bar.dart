...
import 'stream_info_materiel_bar.dart';

class ListMaterielBar extends StatelessWidget {
  ListMaterielBar({key});
  bool affiche = false;
  String search_value = "";
      ...
      appBar: AppBar(
        ...
        title: affiche
            ...
            : Text(
                ...
                style: GoogleFonts.alike(color: Colors.black, fontSize: 15),
              ),
      ),
      body: SizedBox(
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => StreamInfoMaterielBar(
