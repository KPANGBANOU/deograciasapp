...
import 'approvisionner_grand_modele_gerant.dart';

class StreamApprovisionnerGrandModeleGerant extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: ApprovisionnementGrandtModeleGerant(),
    );
  }
}
