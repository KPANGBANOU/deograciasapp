...
import 'facture_de_vente_de_petit_modele.dart';

class VenteDePetitModeleAdmin extends StatelessWidget {
  VenteDePetitModeleAdmin({
    key,
                        ...
                        if (quantite <= _bierre.quantite_physique) {
                          ...
                          await FirebaseFirestore.instance
                            ...
                            'montant_vendu_cumule':
                                _bierre.montant_vendu_cumule + montant,
