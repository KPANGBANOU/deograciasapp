...
import 'stream_approvisionner_petit_modele.gerant.dart';

class ApprovisionnerListPetitModeleGerant extends StatelessWidget {
  ApprovisionnerListPetitModeleGerant({key});
