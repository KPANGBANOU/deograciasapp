...
class BarEnregistrerCreditClient extends StatefulWidget {
  const BarEnregistrerCreditClient({super.key});

  @override
  State<BarEnregistrerCreditClient> createState() =>
      _BarEnregistrerCreditClientState();
}

class _BarEnregistrerCreditClientState
    extends State<BarEnregistrerCreditClient> {
