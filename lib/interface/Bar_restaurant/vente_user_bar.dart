...
import 'package:deogracias/interface/Bar_restaurant/vente_user_deuxieme_date_bar.dart';
import 'package:deogracias/interface/Bar_restaurant/vente_user_intervalle.dart';
...
class VentesUserBar extends StatelessWidget {
  VentesUserBar({
    key,
  ...
  Widget build(BuildContext context) {
    final credits = Provider.of<List<venteCredit>>(context);
    final petit_modele = Provider.of<List<ventePetitModele>>(context);
    final grand_modele = Provider.of<List<venteGrandModele>>(context);
                        ...
                        if (_premiere_date.text.isEmpty &&
                          ...
                          if (nombre_petit_modele <= 0 &&
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => VenteIntervalleUserBar(
