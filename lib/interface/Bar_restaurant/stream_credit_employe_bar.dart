...
import 'bar_credit_employe_bar.dart';

class StreamCreditEmployeBar extends StatelessWidget {
  StreamCreditEmployeBar({
    Key? key,
      ...
      providers: [
        ...
        StreamProvider(
            create: ((context) => context
                .read<serviceBD>()
                .vente_a_credit_servant_bar(credit_uid)),
