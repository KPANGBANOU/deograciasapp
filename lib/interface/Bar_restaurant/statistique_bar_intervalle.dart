// ignore_for_file: prefer_const_constructors, prefer_interpolation_to_compose_strings, must_be_immutable, no_leading_underscores_for_local_identifiers, non_constant_identifier_names, unused_field, avoid_function_literals_in_foreach_calls
...
class StatistiqueBarIntervalle extends StatelessWidget {
  StatistiqueBarIntervalle({
    Key? key,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Statistique de vente réalisé du " +
                    premiere_date +
                    ' au ' +
                    deuxieme_date,
