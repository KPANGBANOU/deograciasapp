...
import 'stream_perte_bar.dart';

class ListPertesBar extends StatelessWidget {
  ListPertesBar({key});
  ...
  Widget build(BuildContext context) {
    final _list_depenses = Provider.of<List<pertesbar>>(context);
      ...
      body: SizedBox(
        ...
        child: ListView.builder(
            ...
            itemBuilder: ((context, index) {
              pertesbar _donnes = _list_depenses[index];
              return !affiche
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => StreamPerteBar(
