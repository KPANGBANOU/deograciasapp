...
class StatistiqueBarAnnuel extends StatelessWidget {
  StatistiqueBarAnnuel({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    for (var element in _ventes_grand_modele) {
      if (element.date_vente_annee == date_saisie) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Statistique annuel de vente de " + date_saisie,
                  ...
                  rows: _petits_modeles.map((_vente) {
                    ...
                    _ventes_petits_modele.forEach((element) {
                      if (element.nom_bierre == _vente.nom &&
                          element.date_vente_annee == date_saisie) {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Bénéfice brute annuel".toUpperCase(),
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold),
                      ),
                      Text(
