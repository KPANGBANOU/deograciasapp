...
class StatistiqueBarMensuel extends StatelessWidget {
  StatistiqueBarMensuel({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    for (var element in _ventes_grand_modele) {
      if (element.date_vente_month == date_saisie) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Statistique mensuel de vente du " + date_saisie,
                  ...
                  rows: _petits_modeles.map((_vente) {
                    ...
                    _ventes_petits_modele.forEach((element) {
                      if (element.nom_bierre == _vente.nom &&
                          element.date_vente_month == date_saisie) {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Bénéfice brute mensuel".toUpperCase(),
                        style: TextStyle(
                            color: Colors.white, fontWeight: FontWeight.bold),
                      ),
                      Text(
