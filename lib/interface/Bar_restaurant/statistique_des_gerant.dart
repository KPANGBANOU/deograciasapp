...
import 'package:deogracias/interface/Bar_restaurant/statistique_du_gerant.dart';
...
class StatistiqueListGerant extends StatelessWidget {
  StatistiqueListGerant({key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    _list_servants.forEach((element) {
      if (element.role == "Gerant" && element.is_active && !element.deleted) {
        nombre++;
      }
    });
