...
class ApprovisionnementGrandtModeleGerant extends StatelessWidget {
  ApprovisionnementGrandtModeleGerant({key});
  ...
  Widget build(BuildContext context) {
    ...
    affiche = _provider.approvisionner_grand_modele;
    return Scaffold(
      drawer: DrawerGerant(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
                padding: const EdgeInsets.only(
                    left: 15.0, right: 15, top: 10, bottom: 70),
                child: SizedBox(
                    height: 55,
                    width: double.infinity,
                    child: ElevatedButton(
                      ...
                      onPressed: (() async {
                        _provider.appro_grand_model_true();
                        ...
                        try {
                          if (_quantite.text.isEmpty || quantite <= 0) {
                            final snakbar = SnackBar(
                              content: Padding(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(
                                    "Vous n'avez pas renseigné la quantité que vous voudriez réchargez ou la quantité saisie est incorrecte. Veuillez réessayez svp !",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 22,
                            ...
                            _provider.appro_grand_model_false();
                          } else {
