...
class EnregistrerVenteACreditBarGerant extends StatefulWidget {
  const EnregistrerVenteACreditBarGerant({super.key});

  @override
  State<EnregistrerVenteACreditBarGerant> createState() =>
      _EnregistrerVenteACreditBarGerantState();
}

class _EnregistrerVenteACreditBarGerantState
    extends State<EnregistrerVenteACreditBarGerant> {
