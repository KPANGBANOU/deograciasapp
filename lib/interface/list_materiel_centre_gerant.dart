...
import 'centre_informatique/stream_info_materiel_centre_gerant.dart';
import 'drawer_gerant.dart';

class CentreListMateriauxGerant extends StatelessWidget {
  CentreListMateriauxGerant({key});
  bool affiche = false;
  String search_value = "";

  @override
  Widget build(BuildContext context) {
    final _list_produits = Provider.of<List<materielCentre>>(context);
      ...
      body: SizedBox(
        ...
        child: ListView.builder(
            ...
            itemBuilder: ((context, index) {
              materielCentre _donnes = _list_produits[index];
              return !affiche
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => StreamInfoMaterielGerant(
