...
class HistoriqueVenteDeuxiemeDateCentre extends StatelessWidget {
  const HistoriqueVenteDeuxiemeDateCentre(
      {super.key, required this.deuxieme_date});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Historique de vente du " + deuxieme_date,
