...
class CentreListCreditsGerant extends StatelessWidget {
  CentreListCreditsGerant({key});
  String _search_value = "";
  bool affiche = false;
  bool is_pressed = false;
  Map<int, bool> selectFlag = {};
  bool is_selected_modele = false;

  @override
  Widget build(BuildContext context) {
    final _list_credits = Provider.of<List<credit>>(context);
    final _provider_pessed = Provider.of<DeleteCredit>(context);
    is_pressed = _provider_pessed.onPressed;
