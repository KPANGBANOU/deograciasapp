...
import 'package:deogracias/interface/centre_informatique/centre_approvisionnement_produit_photocopie_gerant.dart';
...
class StreamApprovisionnerProduitPhotocopiGerant extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: CentreApprovisionnementPhotocopieGerant(),
    );
  }
}
