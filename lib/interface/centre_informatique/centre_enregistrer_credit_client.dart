...
class EnregistrerVenteACreditCentrre extends StatefulWidget {
  const EnregistrerVenteACreditCentrre({super.key});

  @override
  State<EnregistrerVenteACreditCentrre> createState() =>
      _EnregistrerVenteACreditCentrreState();
}

class _EnregistrerVenteACreditCentrreState
    extends State<EnregistrerVenteACreditCentrre> {
