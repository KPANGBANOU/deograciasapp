...
import 'facture_de_vente_de_tee_shirt_admin.dart';

class VenteDeTeeShirtAdmin extends StatelessWidget {
  VenteDeTeeShirtAdmin({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    affiche = _provider.vente_tee_shirt;
                    ...
                    onPressed: (() async {
                      ...
                      try {
                        ...
                        if (_quantite.text.isEmpty || quantite <= 0) {
                          _provider.put_vente_tee_shirt_false();
                          ...
                          if (quantite > _produit.quantite_physique) {
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: ((context) =>
                                        FactureDeVenteDeTeeShirtAdmin(
                                            prix_unitaire:
                                                _produit.prix_unitaire_vente,
                                            produit_nom: _produit.tee_shirt_nom
                                                .toString(),
