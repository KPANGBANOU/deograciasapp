...
class StatistiqueMensuel extends StatelessWidget {
  StatistiqueMensuel({
    Key? key,
    required this.mois_saisie,
  }) : super(key: key);
  final String mois_saisie;
  ...
  Widget build(BuildContext context) {
    ...
    _vente_credits.forEach((element) {
      if (element.date_vente_month == mois_saisie) {
    ...
    _ventes_products.forEach((element) {
      if (element.vente_month == mois_saisie) {
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Statistique mensuel de vente de  " + mois_saisie,
