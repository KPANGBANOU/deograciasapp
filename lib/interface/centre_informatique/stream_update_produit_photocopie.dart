...
import 'package:deogracias/interface/centre_informatique/centre_update_produit_photocopie.dart';
import 'package:deogracias/modele/photocopie.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import '../../base_donne/servicebasededonnees.dart';

class StreamUpdateCentreProduitPhotocopie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: CentreUpdateProduitPhotocopie(),
    );
  }
}
