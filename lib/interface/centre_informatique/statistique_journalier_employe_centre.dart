...
class StatistiqueJournalierEmployeCentre extends StatelessWidget {
  StatistiqueJournalierEmployeCentre({
    key,
  }) : super(key: key);

  int nbre_vente_credit = 0;
  int nbre_vente_tee_shirt = 0;
  int nbre_vente_produit = 0;
  int lengh_credit = 0;
  int lengh_tee_shirt = 0;
  int lengh_product = 0;
