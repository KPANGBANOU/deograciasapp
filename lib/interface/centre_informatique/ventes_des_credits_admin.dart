...
import 'stream_de_vente_de_credit_admin.dart';

class VentesDesCreditsAdmin extends StatelessWidget {
  VentesDesCreditsAdmin({key});
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => StreamDeVenteDeCredit(
