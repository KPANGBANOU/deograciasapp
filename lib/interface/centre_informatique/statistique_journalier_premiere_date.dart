...
class StatistiqueJournalierPremiereDate extends StatelessWidget {
  StatistiqueJournalierPremiereDate({
    Key? key,
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Statistique journalier de vente d'aujourd'hui " + date_saisie,
