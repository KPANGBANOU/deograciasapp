...
import 'statistique_journalier_employe_centre_gerant.dart';
import 'vente_tee_shirt.dart';

class StreamStatistiqueJournalierEmployeCentreGerant extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: StatistiqueJournalierEmployeCentreGerant(),
    );
  }
}
