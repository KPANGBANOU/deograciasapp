...
import 'package:deogracias/interface/centre_informatique/streamapprovisionnementteeshirtgerant.dart';
import 'package:deogracias/interface/centre_informatique/streamupdateteeshirtgerant.dart';
...
class LiquiditeTeeShirtGerant extends StatelessWidget {
  LiquiditeTeeShirtGerant({key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage("images/materiel_centre3.jfif"),
                      fit: BoxFit.fill)),
            ),
            SizedBox(
              height: 40,
            ...
            Text(
              "Liquidité de " + _produit.tee_shirt_nom,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          "Disponibilité du produit".toUpperCase(),
                          maxLines: 1,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        _produit.prix_unitaire_vente.toString() + " XOF",
                        style: GoogleFonts.alike(
                            color: Colors.lightBlue.shade800,
                            fontWeight: FontWeight.bold),
                      )
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    StreamUpdateTeeShirtGerant(
                                        tee_shirt_uid: _produit.uid),
                              ));
                        },
                        child: Text(
                          "Modifiez le tee shirt".toUpperCase(),
                          textAlign: TextAlign.center,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.alike(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        child: Text(
                          "Approvisionnez le tee shirt".toUpperCase(),
                          textAlign: TextAlign.center,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: GoogleFonts.alike(
