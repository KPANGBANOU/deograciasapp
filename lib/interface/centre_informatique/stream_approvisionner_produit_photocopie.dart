...
import 'package:deogracias/interface/centre_informatique/centre_approvisionnement_photocopies.dart';
...
class StreamApprovisionnerProduitPhotocopi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: CentreApprovisionnementPhotocopie(),
    );
  }
}
