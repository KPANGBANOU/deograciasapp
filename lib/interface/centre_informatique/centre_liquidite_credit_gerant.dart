...
import 'package:deogracias/interface/centre_informatique/stream_approvisionner_credit_gerant.dart';
import 'package:deogracias/interface/centre_informatique/stream_update_credit_gerant.dart';
...
class CentreLiquiditeCreditGerant extends StatelessWidget {
  CentreLiquiditeCreditGerant({key});
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => StreamUpdateCreditGerant(
