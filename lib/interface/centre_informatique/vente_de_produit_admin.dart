...
import 'facture_de_vente_de_produit_admin.dart';

class VenteDeProduitAdmin extends StatelessWidget {
  VenteDeProduitAdmin({
    key,
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Vous disposez de  " +
                    ...
                    " unités de ce produit en stock de l'entreprise",
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Quantité restante du produit svp",
