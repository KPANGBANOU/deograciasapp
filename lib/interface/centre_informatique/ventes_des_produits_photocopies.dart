...
import 'package:deogracias/interface/centre_informatique/stream_de_vente_de_produit_photocopie.dart';
...
class VentesDesProduitsPhotocopies extends StatelessWidget {
  VentesDesProduitsPhotocopies({key});
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: ((context) =>
                                    StreamDeVenteDeProduitPhotocopie(
