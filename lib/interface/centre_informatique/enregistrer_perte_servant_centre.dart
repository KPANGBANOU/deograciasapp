...
class EnregistrerPerteServantCentre extends StatelessWidget {
  EnregistrerPerteServantCentre({super.key});
  bool affiche = false;
  String description = "";
  String montant = "";
  int _montant = 0;
                    ...
                    try {
                      ...
                      if (description.isEmpty ||
                        ...
                        await FirebaseFirestore.instance
                            .collection("budget")
                            .doc(budget.uid)
                            .update({"perte": budget.pertes + _montant});
                        _mont.clear();
                        _desc.clear();
                        provider.affiche_false();
