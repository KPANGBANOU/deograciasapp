...
import 'package:deogracias/interface/centre_informatique/centre_stock_physique_produit_photocopie.dart';
...
class StreamStockPhysiqueProduitPhotocopie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: CentreStocjPhysiqueProduitPhotocopie(),
    );
  }
}
