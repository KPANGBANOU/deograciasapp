...
class HistoriqueVenteIntervalleCentre extends StatelessWidget {
  const HistoriqueVenteIntervalleCentre(
      {super.key,
  ...
  Widget build(BuildContext context) {
    ...
    vente_photocopies.forEach((element) {
      if (element.crated_at_in_days >= during_premiere_date &&
          element.crated_at_in_days <= during_deuxieme_date) {
        nombre_photocopies++;
