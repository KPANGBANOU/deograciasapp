...
class UpdateTeeShirtGerant extends StatelessWidget {
  UpdateTeeShirtGerant({
    key,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    affiche = _provider.update_tee_shirt;
    nomProduit.text =
        _produit.tee_shirt_nom.isNotEmpty ? _produit.tee_shirt_nom : "";
    seuilAprovisionnement.text = _produit.seuil_approvisionnement > 0
        ? _produit.seuil_approvisionnement.toString()
        : "0";
    prix_unitaire.text = _produit.prix_unitaire_vente > 0
        ? _produit.prix_unitaire_vente.toString()
        : "0";
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "Prix unitaire d'achat du tee shirt",
                    textAlign: TextAlign.left,
                    style: GoogleFonts.alike(
                        color: Colors.white,
                        fontSize: 20,
              ...
              Padding(
                ...
                child: Container(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "Seuil d'approvisionnement du tee shirt svp",
                    textAlign: TextAlign.left,
                    style: GoogleFonts.alike(
                        color: Colors.white,
                        fontSize: 20,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () async {
                        try {
                          _provider.put_update_tee_shirt_true();
                          ...
                          nom = nomProduit.text.isNotEmpty
                              ? nomProduit.text
                              : _produit.tee_shirt_nom.isNotEmpty
                                  ? _produit.tee_shirt_nom
                                  : "";
                          prix = prix_unitaire.text.isNotEmpty
                              ? int.parse(prix_unitaire.text)
                              : _produit.prix_unitaire_vente > 0
                          ...
                          stock_physique = quantite_physique.text.isNotEmpty
                              ...
                              : _produit.quantite_physique > 0
                                  ...
                                  : 0;
                          if (prix <= prix_achat) {
                            _provider.put_update_tee_shirt_false();
                            ...
                            if (nom == _produit.tee_shirt_nom) {
                              ...
                              _speak(
                                  "La mise à jour des informations rélatives à ce tee shirt a été éffectué avec succès");
                              ...
                              final snakbar = SnackBar(
                                content: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(
                                    "La mise à jour de ce tee shirt a été effectué avec succès",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 22,
                              ...
                              final _result = await FirebaseFirestore.instance
                                  .collection("tee_shirts")
                                  .where("nom_tee_shirt", isEqualTo: nom)
                                  .get();
                              ...
                              if (result) {
                                ...
                                final snakbar = SnackBar(
                                  content: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      "Le nouveau nom que vous proposez correspondant à un tee shirt qui existe dejà dans la base de donnée !",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 22,
