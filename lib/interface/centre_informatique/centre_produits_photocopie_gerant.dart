...
import 'package:deogracias/interface/centre_informatique/centre_stream_stock_physique_produitphotocopie_gerant.dart';
...
class CentreListProduitsPhotocopiesGerant extends StatelessWidget {
  CentreListProduitsPhotocopiesGerant({key});
  bool affiche = false;
  String search_value = "";
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        _speak("Veuillez patientez s'il vous plait");
                        await FirebaseFirestore.instance
                            .collection("photocopies")
                            .doc(produit_uid)
                            .delete();

                        _speak("Le produit a été supprimé avec succès");
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      _speak("Suppression du produit annulée");
                      Navigator.of(context).pop();
                    },
                  ),
                ),
