...
import 'stream_info_materiel_centre.dart';

class ListMaterielCentre extends StatelessWidget {
  ListMaterielCentre({key});
  bool affiche = false;
  String search_value = "";
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => StreamInfoMaterielCentre(
