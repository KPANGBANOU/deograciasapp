...
import 'package:deogracias/interface/centre_informatique/stream_de_vente_de_produit_photocopie_admin.dart';
...
class VentesDesProduitsPhotocopiesAdmin extends StatelessWidget {
  VentesDesProduitsPhotocopiesAdmin({key});
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: ((context) =>
                                    StreamDeVenteDeProduitPhotocopieAdmin(
