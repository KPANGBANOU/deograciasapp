...
import 'stream_depense_employe_centre.dart';

class ListDepenseEmployeCentre extends StatelessWidget {
  ListDepenseEmployeCentre({key});
  ...
  Widget build(BuildContext context) {
    final _list_depenses = Provider.of<List<DepenseCentre>>(context);
      ...
      body: SizedBox(
        ...
        child: ListView.builder(
            ...
            itemBuilder: ((context, index) {
              DepenseCentre _donnes = _list_depenses[index];
              return !affiche
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
