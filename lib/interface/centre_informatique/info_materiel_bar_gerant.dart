...
class InfoMaterielBarGerant extends StatelessWidget {
  const InfoMaterielBarGerant({
    key,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final _materiel = Provider.of<materielBar>(context);
    return Scaffold(
      drawer: DrawerGerant(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Matériel  " + _materiel.nom + " du restaurant",
