...
class HistoriqueVenteAnnuelleCentre extends StatelessWidget {
  const HistoriqueVenteAnnuelleCentre({super.key, required this.annee});
  final String annee;
  @override
