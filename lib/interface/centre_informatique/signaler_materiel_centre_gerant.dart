...
class SignalerMaterielCentreGerant extends StatelessWidget {
  SignalerMaterielCentreGerant({key});
  ...
  Widget build(BuildContext context) {
    ...
    affiche = _provider.signaler_materiel_centre;
    return Scaffold(
      drawer: DrawerGerant(),
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Nombre total du matériel à signaler",
            ...
            Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (() async {
                        _provider.put_signaler_materiel_centre_true();
                        ...
                        try {
                          if (_nombre.text.isEmpty || quantite <= 0) {
                            _provider.put_signaler_materiel_centre_false();
