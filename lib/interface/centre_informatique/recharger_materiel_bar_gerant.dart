...
class RechargerMaterielBarGerant extends StatelessWidget {
  RechargerMaterielBarGerant({key});
  ...
  Widget build(BuildContext context) {
    ...
    affiche = _provider.recharger_materiel_bar;
    return Scaffold(
      drawer: DrawerGerant(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Réchargement de stock de matériel",
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Nombre du matériel à ajouter svp",
            ...
            Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (() async {
                        _provider.put_recharger_materiel_bar_true();
                        ...
                        try {
                          if (_nombre.text.isEmpty || quantite <= 0) {
                            _provider.put_recharger_materiel_bar_false();
