...
class RestaurantGerant extends StatelessWidget {
  const RestaurantGerant({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    grands_modeles.forEach((element) {
      total_grand_modele += element.montant_vendu;
      total_benefice_grand_modele += element.benefice;
    });

    petits_modeles.forEach((element) {
      total_petit_modele += element.montant_vendu;
      total_benefice_petit_modele += element.benefice;
    });
