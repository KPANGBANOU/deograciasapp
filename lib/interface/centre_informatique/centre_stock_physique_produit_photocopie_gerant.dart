...
import 'package:deogracias/interface/centre_informatique/stream_approvisionner_produit_photocopie_gerant.dart';
import 'package:deogracias/interface/centre_informatique/stream_update_produit_photocopie_gerant.dart';
...
class CentreStocjPhysiqueProduitPhotocopieGerant extends StatelessWidget {
  CentreStocjPhysiqueProduitPhotocopieGerant({key});
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    StreamApprovisionnerProduitPhotocopiGerant(
                                        produit_uid: _produit.uid),
                              ));
                        },
                        child: Text(
