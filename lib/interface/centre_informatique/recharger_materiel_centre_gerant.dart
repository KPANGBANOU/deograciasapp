...
class RechargerMaterielCentreGerant extends StatelessWidget {
  RechargerMaterielCentreGerant({key});
  ...
  Widget build(BuildContext context) {
    final _produit = Provider.of<materielCentre>(context);
    final _provider = Provider.of<ProviderGestionGerant>(context);
    affiche = _provider.recharger_materiel_centre;
    return Scaffold(
      drawer: DrawerGerant(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Réchargement de stock du matériel",
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text(
                  "Nombre total du matériel à ajouter svp",
            ...
            Padding(
                ...
                child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (() async {
                        _provider.put_recharger_materiel_centre_true();
                        ...
                        try {
                          if (_nombre.text.isEmpty || quantite <= 0) {
                            _provider.put_recharger_materiel_centre_false();
                            final snakbar = SnackBar(
                              content: Padding(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(
                                    "Vous n'avez pas renseigné le  nombre que vous voudriez réchargez ou le nombre saisi est incorrecte. Veuillez réessayez svp !",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 22,
                            ...
                            await FirebaseFirestore.instance
                                ...
                                .update({
                              "nombre_initial":
                                  _produit.nombre_initial + quantite,
                              "nombre_bon_etat":
                            ...
                            final snakbar = SnackBar(
                              content: Padding(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(
                                    "Le réchargement du nombre du matériel " +
                                        _produit.nom +
