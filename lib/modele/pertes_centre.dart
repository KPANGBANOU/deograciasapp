...
class pertesCentre {
  ...
  factory pertesCentre.fromFirestore(DocumentSnapshot document) {
  ...
  factory pertesCentre.fromMap(Map<String, dynamic> map) {
    return pertesCentre(
      uid: map['uid'] ?? '',
  ...
  factory pertesCentre.fromJson(String source) =>
      pertesCentre.fromMap(json.decode(source));

  @override
  String toString() {
    return 'pertesCentre(uid: $uid, user_uid: $user_uid, created_at: $created_at, created_at_heure: $created_at_heure, description: $description, montant: $montant)';
  }
