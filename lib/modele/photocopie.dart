...
class Photocopies {
  ...
  factory Photocopies.FromFirestore(DocumentSnapshot document) {
    return Photocopies(
  ...
  factory Photocopies.fromMap(Map<String, dynamic> map) {
    return Photocopies(
  ...
  factory Photocopies.fromJson(String source) =>
      Photocopies.fromMap(json.decode(source));

  @override
  String toString() {
    return 'Photocopies(prix_unitaire: $prix_unitaire, quantite_initial: $quantite_initial, quantite_initial_cumule: $quantite_initial_cumule, quantite_physique: $quantite_physique, quantite_physique_cumule: $quantite_physique_cumule, seuil_approvisionnement: $seuil_approvisionnement, nom: $nom, uid: $uid, benefice: $benefice, benefice_cumule: $benefice_cumule, prix_unitaire_achat: $prix_unitaire_achat, montant_vendu: $montant_vendu, montant_vendu_cumule: $montant_vendu_cumule, approvisionne: $approvisionne)';
  }
