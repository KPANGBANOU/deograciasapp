...
class donnesServants {
  ...
  @override
  String toString() {
    return 'donnesServants(nom: $nom, prenom: $prenom, email: $email, telephone: $telephone, role: $role, sexe: $sexe, date_naissance: $date_naissance, uid: $uid, domaine: $domaine, photo_url: $photo_url, admin: $admin, is_active: $is_active, mdp: $mdp, date_inscription: $date_inscription, deleted: $deleted)';
  }
