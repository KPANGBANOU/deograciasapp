...
class venteGrandModele {
  ...
  @override
  String toString() {
    return 'venteGrandModele(uid: $uid, quantite: $quantite, montant: $montant, nom_bierre: $nom_bierre, category: $category, during: $during, date_vente: $date_vente, date_vente_day: $date_vente_day, date_vente_month: $date_vente_month, benefice: $benefice, date_vente_annee: $date_vente_annee, user_uid: $user_uid)';
  }
