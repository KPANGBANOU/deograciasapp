...
class DepenseCentre {
  ...
  @override
  String toString() {
    return 'DepenseCentre(uid: $uid, description: $description, montant: $montant, date: $date, user_nom: $user_nom, user_prenom: $user_prenom, user_uid: $user_uid, numero: $numero, numero_watsapp: $numero_watsapp)';
  }
