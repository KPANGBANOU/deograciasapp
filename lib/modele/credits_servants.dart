...
class VenteACreditBars {
  ...
  factory VenteACreditBars.fromFirestore(DocumentSnapshot document) {
    Timestamp created = (document.data() as Map)['created_at'];
    Timestamp updated = (document.data() as Map)['updated_at'];
    return VenteACreditBars(
        uid: document.id,
  ...
  factory VenteACreditBars.fromMap(Map<String, dynamic> map) {
    return VenteACreditBars(
      uid: map['uid'] ?? '',
  ...
  factory VenteACreditBars.fromJson(String source) =>
      VenteACreditBars.fromMap(json.decode(source));

  @override
  String toString() {
    return 'VenteACreditBars(uid: $uid, nom_client: $nom_client, achat_effectue: $achat_effectue, description: $description, created_at: $created_at, created_at_heure: $created_at_heure, updated_at: $updated_at, updated_at_heure: $updated_at_heure, montant: $montant, paye: $paye, user_uid: $user_uid)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is VenteACreditBars &&
        other.uid == uid &&
