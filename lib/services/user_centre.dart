...
class userCentre {
  ...
  factory userCentre.fromFirestore(DocumentSnapshot snap) {
  ...
  factory userCentre.fromMap(Map<String, dynamic> map) {
    return userCentre(
      nom: map['nom'] ?? '',
      prenom: map['prenom'] ?? '',
      email: map['email'] ?? '',
  ...
  factory userCentre.fromJson(String source) =>
      userCentre.fromMap(json.decode(source));

  @override
  String toString() {
    return 'userCentre(nom: $nom, prenom: $prenom, email: $email, telephone: $telephone, role: $role, sexe: $sexe, date_naissance: $date_naissance, uid: $uid, domaine: $domaine, photo_url: $photo_url, admin: $admin, is_active: $is_active, mdp: $mdp, date_inscription: $date_inscription, deleted: $deleted)';
  }
